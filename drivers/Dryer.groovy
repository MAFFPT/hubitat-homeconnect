 ...
 *
 *  Home Connect Dryer (Child Device of Home Conection Integration)
 *
...
metadata {
    definition(name: "Home Connect Dryer", namespace: "rferrazguimaraes", author: "Rangner Ferraz Guimaraes") {
        capability "Sensor"
        capability "Switch"
